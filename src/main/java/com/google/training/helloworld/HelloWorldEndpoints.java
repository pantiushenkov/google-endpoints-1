...
public class HelloWorldEndpoints {
    ...
    @ApiMethod(name = "tellHowYouFeel", path = "tellHowYouFeel", httpMethod = HttpMethod.GET)
    public HelloClass tellHowYouFeel(@Named("name") String name, @Named("period") String period, @Named("feeling") String feeling) {
        return new HelloClass(name, period, feeling);
    }
