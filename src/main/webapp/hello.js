...
function enableButtons() {
    ...
    btn = document.getElementById("greet_by_period");
    btn.onclick = function () {
        greetByPeriod();
    };
    btn.value = "Click me for a period greeting";

    btn = document.getElementById("tell_how_you_feel");
    btn.onclick = function () {
        tellHowYouFeel();
    };
    btn.value = "Let me know how you feel";
 ...
 */
function tellHowYouFeel() {

    var feeling = document.getElementById("feeling_field").value;
    var name = document.getElementById("name_field").value;
    var period = document.getElementById("period_field").value;

    var request = gapi.client.helloworldendpoints.tellHowYouFeel({"name": name, "period": period, "feeling": feeling});
